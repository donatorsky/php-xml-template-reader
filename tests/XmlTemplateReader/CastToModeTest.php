...
XML
    ...
    public function testFailToCastToNonExistentClass(): void
    {
        ...
        $this->expectExceptionMessage('The "root/nonExistentClass" node\'s tpl:castTo attribute value "\Donatorsky\XmlTemplate\Reader\Tests\XmlTemplateReader\NonExistentNodeClass" refers to non-existent class FQN');
